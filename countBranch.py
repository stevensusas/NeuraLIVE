...
def count_branches(image):
    ...
    return np.count_nonzero((filtered_image > 5/255) & (filtered_image < 0.045))


    # image[((filtered_image > 5/255) & (filtered_image < 0.045))] = (255, 0, 0)

    # filtered_image = np.where(filtered_image > 100/255, 0, filtered_image)
...
cProfile.run("process()", filename = '/Users/stevensu/Desktop/HackHarvard/runtime Neurite.rtf')
p = pstats.Stats('/Users/stevensu/Desktop/HackHarvard/runtime Neurite.rtf')
